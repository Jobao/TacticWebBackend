...
export class AdminController {
    ...
    async autoInsert(){
        ...
        let idJugador1 = (await this.authService.signup({user:"joao", pass:"1234", displayName:"Pastelito"}));
        let idJugador2 =(await this.authService.signup({user:"carlos", pass:"1234", displayName:"Cupcake"}));
