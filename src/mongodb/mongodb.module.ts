...
@Module({
  ...
  providers: [MongodbService,GameMongoRepository, UserMongoRepository, UnitClassMongoRepository],
  exports:[MongooseModule,GameMongoRepository, UserMongoRepository,MongodbService,UnitClassMongoRepository]
})
